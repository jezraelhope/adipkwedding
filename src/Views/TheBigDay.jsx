...
const TheBigDay = () => {
  return (
    <div className="thebigday views text-center top-padding">
      ...
      <div className="whileyouwait md:h-3/5 py-10 flex flex-row bg-gold text-pineTree">
        <div className="flex flex-col items-center px-10 py-12 w-full md:w-1/2">
        ...
        <div className="md:w-1/2 md:flex md:flex-row md:justify-center hidden mt-16">
